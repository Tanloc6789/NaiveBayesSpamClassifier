function out_str=stop_words_removal(inp_str)
...
stopwords_cellstring={'a', 'about', 'above', 'above', 'across', 'after', ...
    ...
    'you', 'your', 'yours', 'yourself', 'yourselves', 'the','i'};
split1 = regexp(inp_str,'\s','Split');
out_str = strjoin(split1(~ismember(split1,stopwords_cellstring)),' ');